...
\begin{enumerate}
    ...
    \item \textbf{y\_train}: Wektor etykiet dla danych treningowych n próbek. Każdy element odpowiada próbce w \textbf{X\_train} i zawiera jej prawdziwą klasę, zazwyczaj 0 i 1 dla klasyfikacji binarnej, liczby całkowite dla wieloklasowej.
