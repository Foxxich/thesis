...
\textbf{Metoda20} ta powstała na bazie idei integracji wielu modeli, gdzie różne klasyfikatory były łączone w celu poprawy ogólnej wydajności predykcyjnej. Inspiracją były również metody stacking, gdzie predykcje modeli bazowych służyły jako cechy dla meta-modelu.
...
\end{enumerate}
Szczegółowy schemat \textbf{metoda20} jest pokazany na \ref{fig:diagram_metoda20}. Pomarańczowe prostokąty odpowiadają pomysłom, które się opierały na podejściu z \textbf{metoda18}. Natomiast zielone prostokąty podkreślają zamysł, którym się inspirowałem z \textbf{metoda19}.
