...
\end{enumerate}
Szczegółowy schemat \textbf{metoda20} jest pokazany na \ref{fig:diagram_metoda20}. Pomysł na taką impelmentacją wynika bardziej nie z jakieś konkretnej metody, a z pomysłu na łączenie klasyfikatorów w celu poprawy ogólnej wydajności predykcyjnej.
