...
\begin{itemize}
    \item Wykresy słupkowe porównujące metryki, takie jak Dokładność, Czas wykonania czy Log Loss, dla różnych metod i zbiorów danych (BuzzFeed, ISOT, WELFake).
