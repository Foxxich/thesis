...
sklasyfikowania przez poprzednie modele. W artykule \cite{metoda8} podkreślono, że ten proces umożliwia tworzenie klasyfikatorów zdolnych do rozwiązywania bardziej złożonych problemów.
...
klasyfikowanie nawet w przypadku danych zawierających istotne różnice.
