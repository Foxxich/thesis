...
sklasyfikowania przez poprzedników. W artykule \cite{metoda8} podkreślono, że ten proces umożliwia tworzenie klasyfikatorów zdolnych do rozwizania bardziej złożonych problemów.
